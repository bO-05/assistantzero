...
export default async function Home() {
  ...
  if (!session) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] my-auto gap-4 animate-fadeIn">
        <h2 className="text-2xl font-semibold">You are not logged in</h2>
        <p className="text-muted-foreground">Please sign in to start using your AI assistant</p>
